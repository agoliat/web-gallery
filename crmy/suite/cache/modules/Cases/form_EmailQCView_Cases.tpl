...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_EmailQCView_Cases","field_to_name_array":{"id":"account_id","name":"account_name"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_EmailQCView_Cases","field_to_name_array":{"id":"assigned_user_id","user_name":"assigned_user_name"}}{/literal}, 
"single", 
true
...
YAHOO.util.Event.onContentReady("form_EmailQCView_Cases",
    function () {ldelim} initEditView(document.forms.form_EmailQCView_Cases) {rdelim});
...
<script type="text/javascript">
addForm('form_EmailQCView_Cases');addToValidate('form_EmailQCView_Cases', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_SUBJECT' module='Cases' for_js=true}{literal}' );
...
addToValidate('form_EmailQCView_Cases', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'case_number', 'int', true,'{/literal}{sugar_translate label='LBL_NUMBER' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'type', 'enum', false,'{/literal}{sugar_translate label='LBL_TYPE' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'status', 'dynamicenum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'priority', 'enum', false,'{/literal}{sugar_translate label='LBL_PRIORITY' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'resolution', 'text', false,'{/literal}{sugar_translate label='LBL_RESOLUTION' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'work_log', 'text', false,'{/literal}{sugar_translate label='LBL_WORK_LOG' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'account_name', 'relate', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_NAME' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'account_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_ID' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'state', 'enum', false,'{/literal}{sugar_translate label='LBL_STATE' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'update_text', 'text', false,'{/literal}{sugar_translate label='LBL_UPDATE_TEXT' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'internal', 'bool', false,'{/literal}{sugar_translate label='LBL_INTERNAL' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'aop_case_updates_threaded', 'function', false,'{/literal}{sugar_translate label='LBL_AOP_CASE_UPDATES_THREADED' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'case_attachments_display', 'function', false,'{/literal}{sugar_translate label='LBL_CASE_ATTACHMENTS_DISPLAY' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'case_update_form', 'function', false,'{/literal}{sugar_translate label='LBL_CASE_UPDATE_FORM' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'contact_created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACT_CREATED_BY_NAME' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'contact_created_by_id', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACT_CREATED_BY_ID' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'jjwg_maps_lng_c', 'float', false,'{/literal}{sugar_translate label='LBL_JJWG_MAPS_LNG' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'jjwg_maps_lat_c', 'float', false,'{/literal}{sugar_translate label='LBL_JJWG_MAPS_LAT' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'jjwg_maps_geocode_status_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_JJWG_MAPS_GEOCODE_STATUS' module='Cases' for_js=true}{literal}' );
addToValidate('form_EmailQCView_Cases', 'jjwg_maps_address_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_JJWG_MAPS_ADDRESS' module='Cases' for_js=true}{literal}' );
addToValidateBinaryDependency('form_EmailQCView_Cases', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Cases' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='Cases' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('form_EmailQCView_Cases', 'account_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Cases' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ACCOUNT_NAME' module='Cases' for_js=true}{literal}', 'account_id' );
