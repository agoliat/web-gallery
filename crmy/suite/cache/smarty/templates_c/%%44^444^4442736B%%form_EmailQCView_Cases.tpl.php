<?php /* Smarty version 2.6.11, created on 2015-06-15 19:00:50
         compiled from cache/modules/Cases/form_EmailQCView_Cases.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 44, false),array('function', 'counter', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 56, false),array('function', 'html_options', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 96, false),array('function', 'sugar_getjspath', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 532, false),array('modifier', 'default', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 121, false),array('modifier', 'count', 'cache/modules/Cases/form_EmailQCView_Cases.tpl', 201, false),)), $this); ?>
...
<div class="action_buttons"><input type="button" class="button" value="   Save   " onclick="SUGAR.email2.detailView.saveQuickCreate(false);" //> <input type="button" class="button" value="   Save & Reply   " onclick="SUGAR.email2.detailView.saveQuickCreate('reply');" //> <input type="button" class="button" value="   Cancel   " onclick="SUGAR.email2.detailView.quickCreateDialog.hide();" //> <?php if ($this->_tpl_vars['bean']->aclAccess('detail')):  if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<div id="form_EmailQCView_Cases_tabs"
>
<div >
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"form_EmailQCView_Cases","field_to_name_array":{"id":"account_id","name":"account_name"}}'; ?>
, 
"single", 
true
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"form_EmailQCView_Cases","field_to_name_array":{"id":"assigned_user_id","user_name":"assigned_user_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
...
YAHOO.util.Event.onContentReady("form_EmailQCView_Cases",
    function () { initEditView(document.forms.form_EmailQCView_Cases) });
...
<script type="text/javascript">
addForm(\'form_EmailQCView_Cases\');addToValidate(\'form_EmailQCView_Cases\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'form_EmailQCView_Cases\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'form_EmailQCView_Cases\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'case_number\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NUMBER','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'status\', \'dynamicenum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'priority\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'resolution\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESOLUTION','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'work_log\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_LOG','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'account_name\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NAME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'account_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'state\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'update_text\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UPDATE_TEXT','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'internal\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_INTERNAL','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'aop_case_updates_threaded\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AOP_CASE_UPDATES_THREADED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'case_attachments_display\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CASE_ATTACHMENTS_DISPLAY','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'case_update_form\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CASE_UPDATE_FORM','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'contact_created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_CREATED_BY_NAME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'contact_created_by_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_CREATED_BY_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'jjwg_maps_lng_c\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_LNG','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'jjwg_maps_lat_c\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_LAT','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'jjwg_maps_geocode_status_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_GEOCODE_STATUS','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'form_EmailQCView_Cases\', \'jjwg_maps_address_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_ADDRESS','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'form_EmailQCView_Cases\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Cases','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Cases','for_js' => true), $this); echo '\', \'assigned_user_id\' );
addToValidateBinaryDependency(\'form_EmailQCView_Cases\', \'account_name\', \'alpha\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Cases','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NAME','module' => 'Cases','for_js' => true), $this); echo '\', \'account_id\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'form_EmailQCView_Cases_account_name\']={"form":"form_EmailQCView_Cases","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["form_EmailQCView_Cases_account_name","account_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'form_EmailQCView_Cases_assigned_user_name\']={"form":"form_EmailQCView_Cases","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
