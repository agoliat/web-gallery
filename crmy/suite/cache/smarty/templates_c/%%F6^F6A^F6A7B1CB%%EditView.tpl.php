<?php /* Smarty version 2.6.11, created on 2015-06-15 19:20:53
         compiled from cache/modules/AOS_Invoices/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/AOS_Invoices/EditView.tpl', 38, false),array('modifier', 'default', 'cache/modules/AOS_Invoices/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/AOS_Invoices/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/AOS_Invoices/EditView.tpl', 298, false),array('modifier', 'count', 'cache/modules/AOS_Invoices/EditView.tpl', 378, false),array('function', 'sugar_include', 'cache/modules/AOS_Invoices/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/AOS_Invoices/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/AOS_Invoices/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/AOS_Invoices/EditView.tpl', 56, false),array('function', 'sugar_number_format', 'cache/modules/AOS_Invoices/EditView.tpl', 117, false),array('function', 'sugar_getimage', 'cache/modules/AOS_Invoices/EditView.tpl', 131, false),array('function', 'html_options', 'cache/modules/AOS_Invoices/EditView.tpl', 273, false),array('function', 'sugar_getjspath', 'cache/modules/AOS_Invoices/EditView.tpl', 630, false),)), $this); ?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='LBL_PANEL_OVERVIEW'  class="yui3-skin-sam edit view panelContainer">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='quote_number_label' width='12.5%' scope="col">
...
' title='' tabindex='0'    >
<td valign="top" id='quote_date_label' width='12.5%' scope="col">
...
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['quote_date']['name']; ?>
...
<td valign="top" id='invoice_date_label' width='12.5%' scope="col">
...
" title=''  tabindex='0'    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['invoice_date']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='LBL_INVOICE_TO'  class="yui3-skin-sam edit view panelContainer">
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_account_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => '','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_account\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ACCOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_contact_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => '','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_contact\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_CONTACT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_address_street\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_STREET','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_address_city\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_CITY','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_address_state\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_STATE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_address_postalcode\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_POSTALCODE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'billing_address_country\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_COUNTRY','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_address_street\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_STREET','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_address_city\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_CITY','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_address_state\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_STATE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_address_postalcode\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_POSTALCODE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_address_country\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_COUNTRY','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'number\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_INVOICE_NUMBER','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'line_items\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LINE_ITEMS','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'total_amt\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TOTAL_AMT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'total_amt_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TOTAL_AMT_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'subtotal_amount\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBTOTAL_AMOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'subtotal_amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBTOTAL_AMOUNT_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'discount_amount\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DISCOUNT_AMOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'discount_amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DISCOUNT__AMOUNT_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'tax_amount\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TAX_AMOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'tax_amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TAX_AMOUNT_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_amount\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_AMOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_AMOUNT_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_tax\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_TAX','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_tax_amt\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_TAX_AMT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'shipping_tax_amt_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_TAX_AMT_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'total_amount\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GRAND_TOTAL','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'total_amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GRAND_TOTAL_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'currency_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'quote_number\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_QUOTE_NUMBER','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'quote_date\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_QUOTE_DATE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'invoice_date\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_INVOICE_DATE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'due_date\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DUE_DATE','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'template_ddown_c[]\', \'multienum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEMPLATE_DDOWN_C','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'subtotal_tax_amount\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBTOTAL_TAX_AMOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'subtotal_tax_amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GRAND_TOTAL_USDOLLAR','module' => 'AOS_Invoices','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'AOS_Invoices','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'AOS_Invoices','for_js' => true), $this); echo '\', \'assigned_user_id\' );
addToValidateBinaryDependency(\'EditView\', \'billing_account\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'AOS_Invoices','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ACCOUNT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\', \'billing_account_id\' );
addToValidateBinaryDependency(\'EditView\', \'billing_contact\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'AOS_Invoices','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_CONTACT','module' => 'AOS_Invoices','for_js' => true), $this); echo '\', \'billing_contact_id\' );
